    ...
    <div class="row justify-content-center">
        <div class="col">
            <div class="card shadow-sm p-4">
                ...
                <form action="<?php echo e(route('profile.update')); ?>" method="POST" class="p-3 bg-white rounded shadow-sm">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layoutDashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pro\composer\petSellingSystem\resources\views/dashboard/profile.blade.php ENDPATH**/ ?>