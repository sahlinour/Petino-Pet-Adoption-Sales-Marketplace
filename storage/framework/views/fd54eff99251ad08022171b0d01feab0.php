...
.home{
  ...
  background:url('<?php echo e(asset('images/beautiful-pet-portrait-small-dog-cat.jpg')); ?>') no-repeat center center/cover;
}
...
.intro__card:nth-child(1) div{
  background-image:url("<?php echo e(asset('images/intro-1-bg.png')); ?>");
}
.intro__card:nth-child(2) div{
  background-image:url("<?php echo e(asset('images/intro-2-bg.png')); ?>");
}
.intro__card:nth-child(3) div{
  background-image:url("<?php echo e(asset('images/intro-3-bg.png')); ?>");
}
...
.banner__card:nth-child(1){
  background-image:url("<?php echo e(asset('images/[GVG] MONCHOUCHOU 2023 신상제품.jpg')); ?>");
}
.banner__card:nth-child(2){
  background-image:url("<?php echo e(asset('images/Tailored Dog Food Delivery.jpg')); ?>");
}
.banner__card:nth-child(3){
  background-image:url("<?php echo e(asset('images/Premium Photo _ Funny wet white cat after bathing wrapped in a blue towel in a pink terry cap on his head.jpg')); ?>");
}
...
</html><?php /**PATH C:\Users\pro\composer\petSellingSystem\resources\views/layouts/layoutHome.blade.php ENDPATH**/ ?>